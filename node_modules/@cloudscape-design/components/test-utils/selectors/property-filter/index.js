...
exports.PropertyFilterEditorDropdownWrapper = exports.FilteringGroupedTokenWrapper = exports.InternalFilteringTokenWrapper = exports.FilteringTokenWrapper = void 0;
...
class FilteringTokenWrapper extends selectors_1.ComponentWrapper {
    ...
    findEditorDropdown(options = {
        ...
        const root = options.expandToViewport ? (0, selectors_1.createWrapper)() : this;
...
class InternalFilteringTokenWrapper extends FilteringTokenWrapper {
    findEditButton() {
...
exports.InternalFilteringTokenWrapper = InternalFilteringTokenWrapper;
class FilteringGroupedTokenWrapper extends selectors_1.ComponentWrapper {
    findLabel() {
...
class PropertyFilterEditorDropdownWrapper extends selectors_1.ComponentWrapper {
    findHeader() {
    ...
    findPropertyField() {
        return this.findComponent(`.${styles_selectors_js_4.default['token-editor-field-property']}`, form_field_1.default);
    }
    findOperatorField() {
        return this.findComponent(`.${styles_selectors_js_4.default['token-editor-field-operator']}`, form_field_1.default);
    }
    findValueField() {
        return this.findComponent(`.${styles_selectors_js_4.default['token-editor-field-value']}`, form_field_1.default);
    }
    findCancelButton() {
